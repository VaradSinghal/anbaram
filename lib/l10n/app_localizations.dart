...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Demo: admin@anbaram.gov.in / anbaram2024'**
  String get loginDemoCredentials;
  ...
  /// No description provided for @todaysDonations.
  ///
  /// In en, this message translates to:
  /// **'Today\'s Donations'**
  String get todaysDonations;

  /// No description provided for @criticalCentres.
  ///
  /// In en, this message translates to:
  /// **'Critical Centres'**
  String get criticalCentres;

  /// No description provided for @pendingNeeds.
  ///
  /// In en, this message translates to:
  /// **'Pending Needs'**
  String get pendingNeeds;

  /// No description provided for @mapDashboard.
  ///
  /// In en, this message translates to:
  /// **'Map Dashboard'**
  String get mapDashboard;

  /// No description provided for @needsOverview.
  ///
  /// In en, this message translates to:
  /// **'Needs Overview'**
  String get needsOverview;
  ...
  /// No description provided for @centreManager.
  ///
  /// In en, this message translates to:
  /// **'Centre Manager'**
  String get centreManager;

  /// No description provided for @wellStocked.
  ///
  /// In en, this message translates to:
  /// **'Well Stocked'**
  String get wellStocked;
